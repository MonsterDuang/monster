<template>
  <v-touch class="Song" @pan="onPan">
    <div class="play">
      <span class="btn-img">
        <i-circle :percent="percent" :stroke-width='2' :trail-width='2' stroke-color='#9d0fbc' stroke-linecap="round" style="width:100%;height:110%">
...
.Song{
  ...
  height: 100%;
  padding-top: 10%;
  background: rgba(200, 10, 242, 0.1);
  color: rgba(200, 10, 242, 0.5);
}
.play{
  width: 100%;
  height: 40%;
