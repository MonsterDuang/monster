<template>
  <div class="Home">
    ...
    <div class="bottom-btn">
      ...
      <router-link to="/like" class="bottom-btn-link"><img src="../../assets/images/heart_tiny.png" alt="" :class="{'animated fadeOut infinite':this.nowPlayList===6}" @click="changeNowPlayList"></router-link>
    </div>
